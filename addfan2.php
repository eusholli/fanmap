...
<div id="page_content">
  <fb:iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="10" marginwidth="0" src="http://64.124.154.141/fanmap/dragmap.php?pid=<?php echo $_GET['fanmap_sig_page_id'] . '&uid=' . $fbid; ?>"></fb:iframe>
</div>
</fb:fbml>
